...
namespace Persistence.Migrations
{
    ...
    [Migration("20260204163412_UpdateAdvertisementSubmoduleCode")]
    partial class UpdateAdvertisementSubmoduleCode
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SPOT_API.Models.AdminitrativeCost", b =>
                {
                    ...
                    b.Property<decimal>("PuspakomAmount")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("SPOT_API.Models.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SPOT_API.Models.CustomerIcDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SPOT_API.Models.ExpenseItem", b =>
                {
                    ...
                    b.Property<string>("BillOrInvoiceNo")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SPOT_API.Models.ExportCertificateDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ExportCertificateDocuments");
                });
            ...
            modelBuilder.Entity("SPOT_API.Models.InsuranceDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SPOT_API.Models.Profile", b =>
                {
                    ...
                    b.Property<Guid?>("IcCopyDocumentId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SPOT_API.Models.ReceiptEDaftarDocument", b =>
                {
                    ...
                    b.ToTable("ReceiptEDaftarDocuments");
                });

            modelBuilder.Entity("SPOT_API.Models.ReceiptKastamDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ReceiptKastamDocuments");
                });
            ...
            modelBuilder.Entity("SPOT_API.Models.RoadTaxDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SPOT_API.Models.Sale", b =>
                {
                    ...
                    b.Property<DateTime>("BookingExpiryDate")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime>("LouDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime>("LouExpiryDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<decimal>("LouPurchasePrice")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("SPOT_API.Models.Stock", b =>
                {
                    ...
                    b.Property<DateTime?>("MovedToStockAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("SPOT_API.Models.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IsActive", "EffectiveUntil");
            ...
            modelBuilder.Entity("SPOT_API.Models.AuditLog", b =>
                {
                    b.HasOne("SPOT_API.Models.AppUser", "User")
                        .WithMany("AuditLogs")
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("SPOT_API.Models.ExportCertificateDocument", b =>
                {
                    b.HasOne("SPOT_API.Models.Clearance", "Clearance")
                        .WithMany("ExportCertificateDocuments")
            ...
            modelBuilder.Entity("SPOT_API.Models.Profile", b =>
                {
                    b.HasOne("SPOT_API.Models.Document", "IcCopyDocument")
                        .WithMany()
                        .HasForeignKey("IcCopyDocumentId");

                    b.HasOne("SPOT_API.Models.Profile", "Leader")
                        .WithMany()
                        .HasForeignKey("LeaderId");

                    b.HasOne("SPOT_API.Models.Document", "PhotoDocument")
                        .WithMany()
            ...
            modelBuilder.Entity("SPOT_API.Models.ReceiptEDaftarDocument", b =>
                {
                    ...
                    b.HasOne("SPOT_API.Models.Registration", "Registration")
                        .WithMany("ReceiptEDaftarDocuments")
                        .HasForeignKey("RegistrationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SPOT_API.Models.ReceiptKastamDocument", b =>
                {
                    ...
                    b.HasOne("SPOT_API.Models.Registration", "Registration")
                        .WithMany("ReceiptKastamDocuments")
                        .HasForeignKey("RegistrationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SPOT_API.Models.Clearance", b =>
                {
                    b.Navigation("ExportCertificateDocuments");
            ...
            modelBuilder.Entity("SPOT_API.Models.Registration", b =>
                {
                    ...
                    b.Navigation("ReceiptEDaftarDocuments");

                    b.Navigation("ReceiptKastamDocuments");

                    b.Navigation("RoadTaxDocuments");
                });
